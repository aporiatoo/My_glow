...
const SCHEMA = {
  ...
  // --- بدن ---
  /* وزن: اگر همه فیلتر شدند، پیش‌فرض برگردد — ویوها به wt[length-1] تکیه دارند */
  wt:       ['arr',  [65], a => { const f = a.filter(x => typeof x === 'number' && x > 0 && x < 300);
                                  return f.length ? f : [65] }],
  hts:      ['arr',  [],   a => a.filter(x => x && x.d && typeof x.v === 'number' && x.v > 80 && x.v < 250)],
  wo:       ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x) && x.d)],
  ft:       ['arr',  []],
  ms:       ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x) && typeof x.min === 'number')],
  fit:      ['arr',  []],
  ...
  // --- ذهن و درس ---
  /* آرایه‌های رکوردی: عنصر باید شیء باشد و کلید تاریخ داشته باشد.
     بدون این، یک null در آرایه کل ویو را می‌شکند. */
  jr:       ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x) && x.d)],
  srs:      ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  mistakes: ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x) && x.q)],
  grades:   ['obj',  {}],
  stLog:    ['obj',  {}],
  hw:       ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  stSess:   ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  exams:    ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x) && x.d)],
  stream:   ['any',  null],
  focus:    ['obj',  {}],

  // --- انضباط ---
  urges:    ['arr',  [],   a => a.filter(x => x && typeof x.h === 'number')],
  skips:    ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  contract: ['any',  null],
  crisis:   ['num',  0],
  ...
  // --- کلیدهایی که قبلاً از اسکیما جا مانده بودند ---
  wr:       ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  tmr:      ['any',  null],
  open:     ['any',  null],
  sk:       ['obj',  {}],
  cap:      ['any',  null],
  ...
  calOff:   ['num',  0],
  zones:    ['obj',  {}],
  footUse:  ['shape', { l: 0, r: 0 }],
  opp:      ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  impact:   ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  showA:    ['bool', 0],
  proj:     ['any',  null],
  contractD:['any',  null],
  notes:    ['obj',  {}],
  obs:      ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],

  // --- سایر ---
  tx:       ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x) && typeof x.v === 'number')],
  goal:     ['num',  0],
  photos:   ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x) && x.d)],
  cook:     ['arr',  [],   a => a.filter(x => typeof x === 'number')],
  hist:     ['arr',  []],
  hist2:    ['arr',  []],
  ach:      ['arr',  [],   a => a.filter(x => typeof x === 'string' || typeof x === 'number')],
  boss:     ['any',  null],
  tree:     ['arr',  [],   a => a.filter(x => typeof x === 'string')],
  prot:     ['obj',  {}],
  mir:      ['obj',  {}],
  hair:     ['arr',  []],
  exit:     ['obj',  {}],
  ...
  fb:       ['obj',  {}],
  protLog:  ['any',  null],
  vids:     ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  fbEst:    ['arr',  [],   a => a.filter(x => typeof x === 'string')],
  lrnTrack: ['str',  'foot'],
  miniOpen: ['any',  null],
  lrnStar:  ['arr',  [],   a => a.filter(x => typeof x === 'string')],
  learn:    ['arr',  [],   a => a.filter(x => typeof x === 'string')],
  golden:   ['arr',  [],   a => a.filter(x => typeof x === 'number')],
  coach:    ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  recent:   ['arr',  [],   a => a.filter(x => typeof x === 'string')],
  matchGoals: ['any',  null],
  gpaCalc:  ['any',  null],
  luNames:  ['obj',  {}],
  luForm:   ['any',  null],
  luKind:   ['str',  'football'],
  lineups:  ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  dec:      ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x))],
  decDrill: ['arr',  [],   a => a.filter(x => typeof x === 'string')],
  decErr:   ['arr',  [],   a => a.filter(x => typeof x === 'string')],
  ai:       ['bool', 1],
  prof:     ['obj',  {}],
  sleepFix: ['any',  null],
  griefFrom:['any',  null],
  buy:      ['obj',  {}],
  honest:   ['arr',  [],   a => a.filter(x => x && typeof x === 'object' && !Array.isArray(x) && x.d)],
  protDay:  ['any',  null],
  fbiq:     ['arr',  [],   a => a.filter(x => typeof x === 'string')],
  fbpos:    ['any',  null],
  mind2:    ['obj',  {}],
  war:      ['obj',  {}],
  blk2:     ['obj',  {}],
